...
namespace ECommerce.Application.Others
{
    ...
    {
        public static string CheckIfUserIsLoggin(IHttpContextAccessor httpContextAccessor)
        {
            if (httpContextAccessor.HttpContext == null || !httpContextAccessor.HttpContext.Request.Headers.ContainsKey("Authorization"))
            {
                return null;
            }
            return GetUserIdFromHttpContextAccessor(httpContextAccessor);
        ...
        public static string GetUserIdFromHttpContextAccessor(IHttpContextAccessor httpContextAccessor)
        {
            ...
            catch (UnauthorizedException ex)
            {
                var errorResponse = new
                {
                    ...
                    additionalData = null as object, // Explicitly setting null type
                    message = ex.Message,
