...
{
    public class CoreException(string code, string message = "", int statusCode = StatusCodes.Status500InternalServerError) : Exception(message)
    {
        public string Code { get; } = code;

        public int StatusCode { get; set; } = statusCode;

        [JsonExtensionData] public required Dictionary<string, object> AdditionalData { get; set; }
